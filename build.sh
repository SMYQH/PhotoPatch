...
$CC_X64 $CFLAGS -shared -o dup2patcher.dll dup2patcher.c dup2patcher.def $LIBS
...
$CC_X64 $CFLAGS -DSTANDALONE_EXE -mwindows -o "Photo Patch.exe" dup2patcher.c resource.res $LIBS
